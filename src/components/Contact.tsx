...
const ContactSection = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const mailtoLink = `mailto:toqaosama86@gmail.com?subject=${encodeURIComponent(values.subject)}&body=${encodeURIComponent(`From: ${values.name}\nEmail: ${values.email}\n\nMessage:\n${values.message}`)}`;
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className="bg-card p-3 rounded-full hover:bg-accent hover:text-white transition-colors"
                  aria-label="GitHub"
                >
